exports.info = (id, SnukBOT, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `🐼 ${SnukBOT} 🐼
...
INFO BOT! :
🔱 *AUTHOR*: Snuk
🔱 *GITHUB*: https://github.com/Snuk69683/NegeriWano
🔱 *INSTAGRAM*: ${MEMEK}
🔱 *YOUTUBE*: ${KONTOL}
🔱 *TELEGRAM* : ${PEJUH}
